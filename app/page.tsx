...
export default async function Home() {
  const getFortune = async () => {
    ...
    if (process.env.NEXT_PUBLIC_API_KEY) {
        ...
        systemInstruction: "be oddly specific, quirky, whimsical, mysterious, but within the bounds of reality. be concise, straight to the point, and occasionally humorous",
        });
